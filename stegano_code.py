...
class Stegano:
    ...
    def check_size(self, data):
        if len(data)+512+450 > self.n_bytes:
            return False
        return True
    ...
    def agregar_relleno(self, plain_text):
        ...
        length_random_str = self.n_bytes - (len(plain_text) + 512 + 450) # Le suma 512, el cual es el tamaño del cs y iv cifrado
...
if __name__ == "__main__":
    ...
    sd = encoder.agregar_relleno(secret_data)
    
    # encode the data into the image
    encoded_image = encoder.encode(sd)
